package com.dev.passbatch.job.notification;

import com.dev.passbatch.repository.booking.BookingEntity;
import com.dev.passbatch.repository.booking.BookingStatus;
import com.dev.passbatch.repository.notification.NotificationEntity;
import com.dev.passbatch.repository.notification.NotificationEvent;
import com.dev.passbatch.repository.notification.NotificationModelMapper;
...
public class SendNotificationBeforeClassJobConfig {
    ...
    public JpaPagingItemReader<BookingEntity> addNotificationItemReader() {
        return new JpaPagingItemReaderBuilder<BookingEntity>()
                ...
                .pageSize(CHUNK_SIZE)
                // 상태(status)가 준비중이며, 시작일시(startedAt)이 10분 후 시작하는 예약이 알람 대상이 됨
     ...
     * Cursor 기법의 ItemReader는 thread-safe하지 않아 Paging 기법을 사용하거나 synchronized 를 선언하여 순차적으로 수행해야함
     */
    @Bean
