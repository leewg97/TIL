...
import com.dev.passbatch.adapter.message.KakaoTalkMessageAdapter;
import com.dev.passbatch.repository.notification.NotificationEntity;
import com.dev.passbatch.repository.notification.NotificationRepository;
...
public class SendNotificationItemWriter implements ItemWriter<NotificationEntity> {
    ...
    public SendNotificationItemWriter(
